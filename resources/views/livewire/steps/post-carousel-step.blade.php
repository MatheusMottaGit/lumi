            ...
            @if ($openImagesModal)
                <div class="bg-black/40 fixed w-full h-full inset-0 flex justify-center items-center z-50">
                    <div class="relative bg-gray-950 w-11/12 max-w-4xl h-3/4 rounded-lg border border-gray-800 p-6 shadow-lg flex flex-col">
                        ...
                        <div class="mt-4">
                            <button type="button" wire:click="postInstagramCarousel" class="w-full px-5 py-2 bg-sky-700 flex items-center justify-center gap-2 text-gray-200 font-medium rounded-lg hover:bg-sky-800 transition shadow-md">
                                Post to Instagram 
                                <img src="{{ url('svg/send.svg') }}" class="w-5 h-5">
                            </button>
                        </div>
                    </div>
                </div>
